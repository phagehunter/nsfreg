...
Restricted Entities."** Built for NSF-affiliated researchers and research
administrators.
...
1. Create a new GitHub repository (e.g. `nsf-restricted-entities-guide`).
2. From this folder:
...
4. The site publishes at `https://<your-username>.github.io/<repo>/` within a
   couple of minutes.
